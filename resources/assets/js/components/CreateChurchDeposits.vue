            ...
            <div class="col-md-12 col-md-offset-0">
                <div id="newMembers" class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class=" col-lg-8 col-md-8  " :class="{'has-feedback has-error':errors.internal_control_id.length > 0}">
                            <div class="panel-default ">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <div id="demo-dt-delete_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                            ...
                            <table class="table table-striped table-bordered dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid"  style="width: 100%;">
                                <thead>
                                <tr role="row">
                                    <th class="sorting_asc" tabindex="0" aria-controls="demo-dt-delete" rowspan="1" colspan="1" aria-sort="ascending"  ></th>
                                    <th class="sorting" tabindex="0" aria-controls="demo-dt-delete" rowspan="1" colspan="1" aria-sort="ascending" style="width: 7%;"  >Numero de Deposito</th>
                                    <th class="sorting" tabindex="0" aria-controls="demo-dt-delete" rowspan="1" colspan="1" >Fecha</th>
                                    <th class="min-tablet sorting" tabindex="0" aria-controls="demo-dt-delete" rowspan="1" colspan="1" >Monto</th>
                                    <th class="min-tablet sorting" tabindex="0" aria-controls="demo-dt-delete" rowspan="1" colspan="1" >Numero de Cuenta</th>
                                    <th class="min-tablet sorting" tabindex="0" aria-controls="demo-dt-delete" rowspan="1" colspan="1" >Nombre de Cuenta</th>
                                    <th class="min-tablet sorting" tabindex="0" aria-controls="demo-dt-delete" rowspan="1" colspan="1" >Ver</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr v-for="(deposit, index) in all_depositos" role="row" class="odd">
                                    <td class="sorting_1"><a @click="remove_deposits(deposit, index)"  target='_blank' class='btn btn-danger'>
