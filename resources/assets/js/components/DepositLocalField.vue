                    ...
                    <div class=" col-lg-3 col-md-3  " :class="{'has-feedback has-error':errors.number.length > 0}">
                        <div class="panel-default ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" placeholder="345634" v-model="data.number" class="form-control">
                            </div>
                    ...
                    <div class=" col-lg-3 col-md-3  " :class="{'has-feedback has-error':errors.bank.length > 0}">
                        <div class="panel-default ">
                            ...
                            <div class="input-group ">
                                ...
                                <v-select v-model="data.bank" placeholder="Seleccion la Cuenta Bancaria"
                                          :options="banks"></v-select>
                            </div>
                            <small class="help-block">{{errors.bank}}</small>
                        </div>
                    </div>
                    <div class=" col-lg-8 col-md-8  "
                         :class="{'has-feedback has-error':errors.check.length > 0}">
                        <div class="panel-default ">
                            <label>Cheques sin Reportar</label>
                            <div class="input-group ">
                                <span class="input-group-addon"><i class="fa fa-archive"></i></span>
                                <v-select placeholder="Seleccione El cheque que deposito para reportar"
                                         v-model="data.check" :options="checks"
                                          ></v-select>
                            </div>
                            <small class="help-block">{{errors.check}}</small>
                        </div>
                    </div>
